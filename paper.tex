...
tool. Every fixture in the Csound suite compiles without error and was
auditioned.
...
5.0$\,s), while in the MusicXML export only the second tempo mark changes ($90
\to 60$~BPM)---the initial $120$ and every written note-duration unchanged:
